...
EXAMPLE_DIR="${ALF_GPU4PYSCF_EXAMPLE_DIR:-/vast/home/pjlohr/ALF_LANL/ALF_fork/ALF/examples/excited_state_gpu4pyscf_nacr}"
...
echo "Starting seeded excited-state GPU4PySCF ALF workflow with NACR labeling"
